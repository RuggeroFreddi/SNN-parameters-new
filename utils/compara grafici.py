...
# =========================
#  Funzione per curva + banda std
# =========================
def plot_with_std(x, y, ystd, label, marker):
    """
    Disegna curva y(x) e banda di ±ystd.
    """
...
#  Lettura file
# =========================
base_dir = "compare/trace_accuracy/"
...
if not df_beta_1.empty:
    plot_with_std(
        df_beta_1["weight"],
        df_beta_1["accuracy_rf_smooth"],
        df_beta_1["std_accuracy_rf"],
        "beta (min param)",
        "o"
    )
...
if not df_curr_1.empty:
    plot_with_std(
        df_curr_1["weight"],
        df_curr_1["accuracy_rf_smooth"],
        df_curr_1["std_accuracy_rf"],
        "current_amp (min param)",
        "s"
    )
...
if not df_mem_1.empty:
    plot_with_std(
        df_mem_1["weight"],
        df_mem_1["accuracy_rf_smooth"],
        df_mem_1["std_accuracy_rf"],
        "membrane (max param)",
        "^"
    )

plt.xlabel("weight")
plt.ylabel("accuracy_rf (smoothed)")
...
if not df_beta_2.empty:
    plot_with_std(
        df_beta_2["weight"],
        df_beta_2["accuracy_rf_smooth"],
        df_beta_2["std_accuracy_rf"],
        "beta (2° param)",
        "o"
    )
...
if not df_curr_2.empty:
    plot_with_std(
        df_curr_2["weight"],
        df_curr_2["accuracy_rf_smooth"],
        df_curr_2["std_accuracy_rf"],
        "current_amp (2° param)",
        "s"
    )
...
if not df_mem_2.empty:
    plot_with_std(
        df_mem_2["weight"],
        df_mem_2["accuracy_rf_smooth"],
        df_mem_2["std_accuracy_rf"],
        "membrane (2° param)",
        "^"
    )
...
if not df_beta_3.empty:
    plot_with_std(
        df_beta_3["weight"],
        df_beta_3["accuracy_rf_smooth"],
        df_beta_3["std_accuracy_rf"],
        "beta (max param)",
        "o"
    )
...
if not df_curr_3.empty:
    plot_with_std(
        df_curr_3["weight"],
        df_curr_3["accuracy_rf_smooth"],
        df_curr_3["std_accuracy_rf"],
        "current_amp (max param)",
        "s"
    )
...
if not df_mem_3.empty:
    plot_with_std(
        df_mem_3["weight"],
        df_mem_3["accuracy_rf_smooth"],
        df_mem_3["std_accuracy_rf"],
        "membrane (min param)",
        "^"
    )
...
if "accuracy_slp_smooth" in df_beta_1:
    plot_with_std(
        df_beta_1["weight"],
        df_beta_1["accuracy_slp_smooth"],
        df_beta_1["std_accuracy_slp"],
        "beta (min param)",
        "o"
    )
...
if "accuracy_slp_smooth" in df_curr_1:
    plot_with_std(
        df_curr_1["weight"],
        df_curr_1["accuracy_slp_smooth"],
        df_curr_1["std_accuracy_slp"],
        "current_amp (min param)",
        "s"
    )
...
if "accuracy_slp_smooth" in df_mem_1:
    plot_with_std(
        df_mem_1["weight"],
        df_mem_1["accuracy_slp_smooth"],
        df_mem_1["std_accuracy_slp"],
        "membrane (max param)",
        "^"
    )

plt.xlabel("weight")
plt.ylabel("accuracy_slp (smoothed)")
...
if "accuracy_slp_smooth" in df_beta_2:
    plot_with_std(
        df_beta_2["weight"],
        df_beta_2["accuracy_slp_smooth"],
        df_beta_2["std_accuracy_slp"],
        "beta (2° param)",
        "o"
    )
...
if "accuracy_slp_smooth" in df_curr_2:
    plot_with_std(
        df_curr_2["weight"],
        df_curr_2["accuracy_slp_smooth"],
        df_curr_2["std_accuracy_slp"],
        "current_amp (2° param)",
        "s"
    )
...
if "accuracy_slp_smooth" in df_mem_2:
    plot_with_std(
        df_mem_2["weight"],
        df_mem_2["accuracy_slp_smooth"],
        df_mem_2["std_accuracy_slp"],
        "membrane (2° param)",
        "^"
    )
...
if "accuracy_slp_smooth" in df_beta_3:
    plot_with_std(
        df_beta_3["weight"],
        df_beta_3["accuracy_slp_smooth"],
        df_beta_3["std_accuracy_slp"],
        "beta (max param)",
        "o"
    )
...
if "accuracy_slp_smooth" in df_curr_3:
    plot_with_std(
        df_curr_3["weight"],
        df_curr_3["accuracy_slp_smooth"],
        df_curr_3["std_accuracy_slp"],
        "current_amp (max param)",
        "s"
    )
...
if "accuracy_slp_smooth" in df_mem_3:
    plot_with_std(
        df_mem_3["weight"],
        df_mem_3["accuracy_slp_smooth"],
        df_mem_3["std_accuracy_slp"],
        "membrane (min param)",
        "^"
    )
